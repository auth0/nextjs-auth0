          ...
          <div className="card">
            ...
            <div className="card-body">
              <div className="alert alert-info">
                <strong>Server Component Context:</strong> This page is rendered on the server using Next.js Server Components. 
                The DPoP API call happens during server-side rendering, and the results are included in the initial HTML.
                Note: Server Components cannot set cookies, so token refresh may not persist properly.
              </div>
