...
| authorizationParameters     | `AuthorizationParameters` | The authorization parameters to pass to the `/authorize` endpoint. See [Passing authorization parameters](./EXAMPLES.md#passing-authorization-parameters) for more details.                                                                         |
...
| session                     | `SessionConfiguration`    | Configure the session timeouts and whether to use rolling sessions or not. See [Session configuration](./EXAMPLES.md#session-configuration) for additional details.                                                                                 |
| beforeSessionSaved          | `BeforeSessionSavedHook`  | A method to manipulate the session before persisting it. See [beforeSessionSaved](./EXAMPLES.md#beforesessionsaved) for additional details.                                                                                                         |
| onCallback                  | `OnCallbackHook`          | A method to handle errors or manage redirects after attempting to authenticate. See [onCallback](./EXAMPLES.md#oncallback) for additional details.                                                                                                  |
| sessionStore                | `SessionStore`            | A custom session store implementation used to persist sessions to a data store. See [Database sessions](./EXAMPLES.md#database-sessions) for additional details.                                                                                    |
...
| routes                      | `Routes`                  | Configure the paths for the authentication routes. See [Custom routes](./EXAMPLES.md#custom-routes) for additional details.                                                                                                                         |
