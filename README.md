...
Create a [catch-all, dynamic API route handler](https://nextjs.org/docs/pages/building-your-application/routing/api-routes#catch-all-api-routes) under the `/pages/api` directory:
