...
- `APP_BASE_URL=https://app.example.com/app` (single value, no commas) behaves the same as the static string above. Use commas to enable allow-list behavior from env.
