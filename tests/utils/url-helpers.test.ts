  ...
  describe('isSafeRedirect', () => {
    ...
    test('should prevent open redirects', () => {
      const payloads = [
        ...
        'data:whitelisted.com;text/html;charset=UTF-8,<html><script>document.write(document.domain);' +
          '</script><iframe/src=xxxxx>aaaa</iframe></html>',
    ...
    test('should throw for empty redirect', () => {
