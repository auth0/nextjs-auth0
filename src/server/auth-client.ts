...
export interface AuthClientOptions {
  ...
  clientId: string;
  clientSecret?: string;
  clientAssertionSigningKey?: string | jose.KeyLike;
...
export class AuthClient {
  ...
  private clientAssertionSigningKey?: string | jose.KeyLike;
  ...
  private async getClientAuth(): Promise<oauth.ClientAuth> {
    ...
    let clientPrivateKey: jose.KeyLike | undefined = this
      .clientAssertionSigningKey as jose.KeyLike | undefined;
